...
public class Bot : MonoBehaviour
{
   ...
   */
    ...
    public void PerformActionOnRegion(RegionData region)
    {
        // Примерна имплементация:
        float influenceToAdd = Random.Range(5f, 15f);
        region.UpdateBotInfluence(influenceToAdd);

        Debug.Log($"Bot performed action on {region.regionName}");
    }
}
